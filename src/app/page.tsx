  ...
  return (
    <>
      ...
      <section className="bg-navy-dark border-b border-white/10">
        <div className="max-w-content mx-auto px-5 pt-16 pb-20 md:pt-24 md:pb-28">
          <span className="font-body text-xs font-bold tracking-widest uppercase text-orange">
            The Rojas Report Investigation
          </span>
          <h1 className="mt-4 font-display text-4xl sm:text-5xl md:text-6xl font-bold text-cream leading-tight tracking-tight max-w-4xl">
            Certificate of Need Laws:{' '}
            <span className="text-orange">The Architecture of a Healthcare Monopoly</span>
          </h1>
          <p className="mt-5 font-body text-base md:text-lg text-cream/55 leading-relaxed max-w-3xl">
      ...
      <section className="border-b border-white/10">
        <div className="max-w-content mx-auto px-5 py-16 md:py-20">
          <SectionHeader
            ...
            subtitle="Color-coded by restrictiveness. Click any state with a CON law to view its full intelligence dossier."
          />
          <ConMap states={mapStates} />
          <div className="mt-6 flex flex-wrap items-center gap-4 justify-center">
            {[
              ['Free Market', 'bg-tier-free'],
              ['Mostly Free', 'bg-tier-mostly-free'],
              ['Moderate', 'bg-tier-moderate'],
              ['Restrictive', 'bg-tier-restrictive'],
              ['Highly Restrictive', 'bg-tier-highly-restrictive'],
              ['Most Restrictive', 'bg-tier-most-restrictive'],
            ].map(([label, bg]) => (
      ...
      <section className="bg-navy-dark border-b border-white/10">
        <div className="max-w-content mx-auto px-5 py-16 md:py-20">
          <SectionHeader
            ...
            subtitle="The Federal Trade Commission and the Department of Justice have found no reliable evidence that CON programs achieve any public benefits."
          />
          <EvidencePreview />
        </div>
      </section>
      ...
      <section className="border-b border-white/10">
        <div className="max-w-content mx-auto px-5 py-16 md:py-20">
          <SectionHeader
            ...
            subtitle="Each profile includes market concentration data, case law, reform status, and the names of the systems that benefit from the monopoly."
          />
          ...
          <div className="mt-8 text-center">
            <Link
              href="/rankings/"
              className="inline-block font-body text-sm font-semibold text-orange hover:text-orange-light transition-colors border border-orange/30 px-6 py-3 hover:border-orange/60"
            >
      ...
      <section className="bg-navy-dark">
        <div className="max-w-content mx-auto px-5 py-16 md:py-20 text-center">
          <p className="font-body text-xs font-bold tracking-widest uppercase text-cream/40 mb-4">
          ...
          <p className="mt-3 font-body text-sm text-cream/50 max-w-2xl mx-auto leading-relaxed">
            Not KFF. Not Mercatus. Not Cicero. Not the AHA. This is the definitive Certificate
